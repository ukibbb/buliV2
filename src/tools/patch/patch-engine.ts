...
import { createUnifiedDiff, UnifiedDiffTooLargeError } from "@/tools/patch/diff"
...
/** Reports that workspace state changed after a patch proposal was prepared. */
...
/** Reports cancellation observed only after a workspace patch committed. */
