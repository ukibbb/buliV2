...
import { pathExists, resolveToCwd } from "@/agent/tools/shared/path-utils"
import {
    DEFAULT_MAX_BYTES,
    formatSize,
    truncateHead,
...
export const FindTool: IAgentToolDeclaration<{
    ...
    create: ({ workspaceRoot, fdExecutablePath }) => createFindTool(
        workspaceRoot,
        fdExecutablePath,
    ),
}
