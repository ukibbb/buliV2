...
import { BULI_COMMANDS } from "@/ui/commands/catalog"
import type {
    IBuliCommandContext,
    IBuliCommandInfo,
} from "@/ui/commands/types"
import { BuliCommandMenu } from "@/ui/controller/command-menu"
import {
    cloneUserInput,
    mergeUserInputs,
    sameUserInput,
...
} from "@/ui/controller/input-submission"
import {
    BuliPathMenu,
...
export class BuliUiController implements ISnapshotSource<IBuliUiSnapshot> {
    ...
    readonly getInputDraft = (): IUserInputContent => {
    ...
    private readonly consumeInputDraft = (input: IUserInputContent): void => {
